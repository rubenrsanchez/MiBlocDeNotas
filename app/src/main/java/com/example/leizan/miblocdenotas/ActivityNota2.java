...
//        notasList = (ArrayList<Nota>) getIntent().getSerializableExtra("notas");
        ...
        guardar.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
              ...
              //la acabo de comentar  intent.putExtra("nota" , new Nota(titulo.getText().toString(), text.getText().toString(), new CategoriaNota(1,2, 2))); // añade la nota creada por el usuario al intent
